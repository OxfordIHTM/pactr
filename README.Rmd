...
If you find the `pactr` package useful please cite using the suggested citation provided by a call to the `citation()` function as follows:
...
This project is released with a [Contributor Code of Conduct](https://OxfordIHTM/pactr/CODE_OF_CONDUCT.html). By participating in this project you agree to abide by its terms.
